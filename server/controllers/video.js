...
export const getTrend = async (req, res, next) => {
  try {
    // 1: increasing order; -1: decreasing order
...
export const search = async (req, res, next) => {
  ...
  try {
    // i means unsensitive in upper case or lower case
...
export const like = async (req, res, next) => {
  ...
  try {
    // addtoset can make sure the element only appear once
